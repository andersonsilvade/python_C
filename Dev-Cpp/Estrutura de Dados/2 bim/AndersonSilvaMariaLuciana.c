...
int num_buscas(int v[],int v_aux[],int n,double tempo_ordenacao){
 	int i = 0;
 	double inicio_tempo1 = 0;
 	double inicio_tempo2 = 0;
 	double tempo_BuscaSeq = 0;
 	double tempo_BuscaBin = tempo_ordenacao;
 	int x = rand();
 	
 	inicio_tempo1 = tempo();
 	BuscaSequencial(x,n,v);
 	tempo_BuscaSeq = abst(tempo() - inicio_tempo1);
 	
 	inicio_tempo2 = tempo();
 	BuscaBinaria(x,n,v_aux);
 	tempo_BuscaBin += abst(tempo() - inicio_tempo2);
...
int main(int argc,char **argv) {
    ...
    printf("|-------------------------[EP1 - Vale a pena ordenar?]-----------------|\n"
        ...
        "|            Nome: Anderson Silva de Albuquerque && Maria Luciana Felix   |\n"
        "|-------------------------------------------------------------------------|\n"
