...
int num_buscas(int v[],int v_aux[],int n,double tempo_ordenacao){
 	...
 	double time1 = 0;
 	double time2 = 0;
 	double timeBuscaSeq = 0;
 	double timeBuscaBin = tempo_ordenacao;
 	int x = rand();
 	
 	time1 = tempo();
 	BuscaSequencial(x,n,v);
 	timeBuscaSeq = abst(tempo() - time1);
 	
 	time2 = tempo();
 	BuscaBinaria(x,n,v_aux);
 	timeBuscaBin += abst(tempo() - time2);
 	
 	
 	while(timeBuscaBin >= timeBuscaSeq){
 		x = rand();
...
int main(int argc,char **argv) {
 ...
 printf("|-------------------------[EP1 - Vale a pena ordenar?]--------------------|\n"
        ...
        "|            nome: Anderson Silva de Albuquerque                          |\n"
        "|-------------------------------------------------------------------------|\n"
