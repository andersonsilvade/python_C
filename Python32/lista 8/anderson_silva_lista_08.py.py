...
def count_code(s):
  ...
  for k in range (len(s)-3):
    if s[k]=='c' and s[k+1]== 'o' and s[k+3]=='e':
      c+=1      
...
def soma_na_lista(n, lista):
  if lista[0]!= lista[1] or lista [0]!= lista[2] or lista[0]!=lista[3] or lista[1]!=lista[2] or lista[2]!=lista[3] or lista[1]!=lista[3]:
    if lista[0]+lista[1]==n or lista[0]+lista[2]==n or lista [0]+lista[3]==n or lista [1]+lista[2]==n or lista [1]+lista[3]==n or lista [2]+lista[3]==n:
      return True
  return False
